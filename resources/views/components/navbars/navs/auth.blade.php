...
{{--                        <i class="fa fa-user me-sm-1"></i>--}}
                ...
                <li class="nav-item px-1 ps-3 d-flex align-items-center">
                ...
                <li class="nav-item d-xl-none ps-3 d-flex align-items-center">
                    <a href="javascript:;" class="nav-link text-body p-0" id="iconNavbarSidenav">
                        <div class="sidenav-toggler-inner fs-2">
                            <i class="sidenav-toggler-line d-block mb-1" style="height: 4px; width: 30px;"></i>
                            <i class="sidenav-toggler-line d-block mb-1" style="height: 4px; width: 30px;"></i>
                            <i class="sidenav-toggler-line d-block" style="height: 4px; width: 30px;"></i>
                        </div>
                    </a>
                </li>
