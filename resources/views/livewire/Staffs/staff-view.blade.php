            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    ...
                    <div class="bg-gradient-{{$activeColor}} shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white mx-3"><strong> Add, Edit, Delete Staffs</strong></h6>
                    </div>
                </div>
                <div class=" me-3 my-3 text-end">
                    <a class="btn bg-gradient-dark mb-0" href="{{ route('add-staff') }}"><i
                            class="material-icons text-sm">add</i>&nbsp;&nbsp;Add New Staff</a>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <span class="text-secondary text-s font-weight-bold">
                                            ...
                                            @can('staff-edit')
                                                <a rel="tooltip" class="btn btn-success btn-link" href="{{ route('edit-staff', $u->id) }}" data-original-title="" title="">
