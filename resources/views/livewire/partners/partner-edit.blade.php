                ...
                <div class="card-body">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <!-- Show existing image -->
                                    @if ($existingImage && !$newImageUploaded)
                                        <div class="mt-2 position-relative d-inline-block">
                                            <div class="shadow-sm border-radius-lg overflow-hidden" style="width: 200px; height: 260px; border: 3px solid #fff;">
                                                <img src="{{ asset('storage/' . $existingImage) }}" style="width: 100%; height: 100%; object-fit: cover;">
                                            </div>
                                            <button type="button" wire:click="removeImage" 
                                                    class="position-absolute btn btn-sm btn-danger rounded-circle p-0 d-flex align-items-center justify-content-center shadow"
                                                    style="width: 35px; height: 35px; top: -10px; right: -10px; z-index: 10;"
                                                    title="Remove Image">
                                    ...
                                    @if (!$existingImage && !$newImageUploaded)
                                        <p class="text-sm text-muted mt-2">No image uploaded</p>
                                    @endif
                                </div>
                            </div>
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="button" wire:click="update" wire:loading.attr="disabled" wire:target="update"
                            ...
                            <span wire:loading.remove wire:target="update">Update Partner</span>
