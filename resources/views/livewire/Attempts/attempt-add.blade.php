                ...
                <div
                    ...
                    <div class="row mb-3 align-items-end">
                        ...
                        <div class="col-md-3 form-column">
                            <label for="successful" class="text-secondary" style="font-size: 24px; font-weight: bold">Successful?</label>
                            ...
                            @error('successful') <div class="text-danger">{{ $message }}</div> @enderror
                        </div>
                        ...
                        <div class="col-md-3 form-column ms-auto text-end" x-show="successful" x-cloak>
                            <label for="lubrication_used" class="text-secondary" style="font-size: 24px; font-weight: bold">Lubrication Used?</label>
                            ...
                            @error('lubrication_used') <div class="text-danger">{{ $message }}</div> @enderror
                        </div>
