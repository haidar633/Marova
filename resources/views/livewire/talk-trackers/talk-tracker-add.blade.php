    ...
    <div class="container">
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <span>Create Talk Tracker Entry</span>
                ...
                <form wire:submit.prevent="store">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Topic</label>
                                <input type="text" wire:model="topic" class="form-control border border-2 p-2" placeholder="What was the conversation about?">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" wire:model="connection_rating" min="1" max="5" step="0.5" class="form-control border border-2 p-2" placeholder="How heard did you feel?">
                                @error('connection_rating') <div class="text-danger">{{ $message }}</div> @enderror
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Link to Mood Journal (Optional)</label>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea wire:model="resolution_summary" class="form-control border border-2 p-2" rows="5" placeholder="How was the conversation resolved?"></textarea>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <button type="submit" class="btn bg-gradient-dark btn-md">Save Entry</button>
                    </div>
                </form>
            </div>
        </div>
