            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    ...
                    <div class="bg-gradient-{{$activeColor}} shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white mx-3"><strong> Add, Edit, Delete Doctors</strong> </h6>
                    </div>
                </div>
                <div class=" me-3 my-3 text-end">
                    <a class="btn bg-gradient-dark mb-0" href="{{ route('add-doctor') }}"><i
                            class="material-icons text-sm">add</i>&nbsp;&nbsp;Add New Doctor</a>
                </div>
                                ...
                                @foreach ($doctors as $key => $u)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="form-check form-switch d-flex justify-content-center">
                                                <input
                                                    ...
                                                    type="checkbox"
                                                    wire:change="toggleActive({{ $u->id }})"
                                                    id="flexSwitchCheckDefault-{{ $u->id }}"
                                                    @if(optional($u->userDetail)->dr_is_active !== '0') checked @endif
                                                >
                                            </div>
                                        </td>
                                        ...
                                        <span class="text-secondary text-s font-weight-bold">
                                            ...
                                            @can('doctor-edit')
                                                <a rel="tooltip" class="btn btn-success btn-link" href="{{ route('edit-doctor', $u->id) }}" data-original-title="" title="">
