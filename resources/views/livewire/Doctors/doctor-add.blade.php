<div>
    <div class="container">
        <div class="justify-content-center">
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">Create Doctor
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-6 mt-3">
                            ...
                            @error('serial_nb')
                            <div class="text-danger">The serial number field is required.</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-6 mt-3">
                            ...
                            <input wire:model="dr_percentage" type="number"
                                   class="form-control border border-2 p-2" placeholder="Enter percentage (%)"
                                   id="dr_percentage">
                            @error('dr_percentage')
                            <div class="text-danger">The doctor percentage number field is required.</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-6 mt-3">
                            ...
                            <input wire:model="speciality" type="text"
                                   class="form-control border border-2 p-2" placeholder="Enter doctor's speciality"
                                   id="speciality">
                            @error('speciality')
                            <div class="text-danger">The doctor speciality field is required.</div>
                            @enderror
                        </div>
